...
def description_api():
    description = '''Teste para vaga Desenvolvedor Home Office na Digistarts disponível no repositório:
    <a href=\"https://github.com/brlga002/Python-Rest-API\" target=\"_blank\">Python Rest API</a> Uma versão em note está em <a href=\"https://github.com/brlga002/digistarts\" target=\"_blank\">digistarts</a>'''
    return description
